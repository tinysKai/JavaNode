...
public class DownloadUtil {
     ...
     * @param filename 文件名称
     */
    public static void prepareHeader(String filename,
                                     HttpServletRequest request,
                                     HttpServletResponse response) throws IOException {
        // 设置返回类型
        response.setContentType(MimeMappings.DEFAULT.get(FileUtil.extName(filename)));
        // 设置返回文件名
...
public final class MimeMappings implements Iterable<MimeMappings.Mapping> {
     ...
     */
    public String getOrNull(String extension) {
     ...
     *
     * @param extension the file extension (excluding '.')
     * @return a mime mapping or 'application/octet-stream' for unknown
     */
    public String get(String extension) {
        return ValueUtil.defaultIfNull(getOrNull(extension), "application/octet-stream");
    }
...
```java
 public void exportExcelTemplate(HttpServletRequest request, HttpServletResponse response) throws IOException {
        DownloadUtil.prepareHeader("模板.xlsx", request, response);
        File template = FileUtil.file(pageChatConfig.getTemplatePath());
