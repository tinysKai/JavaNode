...
![redis](https://github.com/tinysKai/Note/blob/master/image/article/2018/0709/redis082701.png) 
...
![redis](https://github.com/tinysKai/Note/blob/master/image/article/2018/0709/redis082702.png)  
...
结构图  
![redis](https://github.com/tinysKai/Note/blob/master/image/article/2018/0709/redis082703.png)
...
结构图  
![redis](https://github.com/tinysKai/Note/blob/master/image/article/2018/0709/redis082801.png)  
...
```
结构图  
![redis](https://github.com/tinysKai/Note/blob/master/image/article/2018/0709/redis082802.png)  
...
结构图  
![redis](https://github.com/tinysKai/Note/blob/master/image/article/2018/0709/redis082803.png)    
...
### 紧凑列表-listpack
![redis](https://github.com/tinysKai/Note/blob/master/image/article/2018/0709/redis090101.png)   
...
计算规则  
![redis](https://github.com/tinysKai/Note/blob/master/image/article/2018/0709/redis090102.png)   
  
  
##### LFU
在 LFU 模式下，lru 字段 24 个 bit 用来存储两个值，分别是ldt(last decrement time)和logc(logistic counter)。  
![redis](https://github.com/tinysKai/Note/blob/master/image/article/2018/0709/redis090103.png)  
...
计算空闲时间(单位分钟)  
![redis](https://github.com/tinysKai/Note/blob/master/image/article/2018/0709/redis090104.png)  
